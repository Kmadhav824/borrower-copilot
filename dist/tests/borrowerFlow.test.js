...
import { getNextQuestion, getVisibleQuestions, normalizeAnswers, toAssessmentInput } from "../src/application/borrowerFlow.js";
const known = (value) => ({ kind: "known", value });
const unknown = () => ({ kind: "unknown", reason: "Not provided" });
const offer = {
...
function coreAnswers(overrides = {}) {
    return {
        incomeType: "salaried",
        purpose: "personal",

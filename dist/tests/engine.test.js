...
const range = (low, high) => ({ kind: "range", low, high });
const offer = {
...
function request(amount, purpose, productIntent, tenure = 60) {
...
test("rules are configurable and the safety cap is not embedded in UI logic", () => {
    const input = { borrower: profile(), request: request(800_000, "wedding", "personalLoan"), offer };

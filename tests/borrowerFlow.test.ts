...
import type { Known, KnownRange, LoanOfferInputs, NumericInput } from "../src/domain/borrower/types.js";
...
test("range and credit-score answers survive normalization without collapsing", () => {
  ...
  const income = normalized.borrower!.financial.monthlyIncome as KnownRange;
  ...
  const score = normalized.borrower!.credit.score as Known;
